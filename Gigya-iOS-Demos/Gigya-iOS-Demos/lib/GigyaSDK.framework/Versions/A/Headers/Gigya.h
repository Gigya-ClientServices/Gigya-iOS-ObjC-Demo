...
// Consts
static NSString * const GSGigyaSDKVersion = @"iOS_3.4.0";
...
/**
 ...
 For a complete list, see <a target="_blank" href="http://developers.gigya.com/037_API_reference/zz_Response_Codes_and_Errors">Response Codes and Errors</a>.
 */
...
/*!
 ...
 If the provider supports <a target="_blank" href="http://developers.gigya.com/035_Mobile_SDKs/010_iPhone#c._Additional_Provider_Configuration">native login</a>, it will be used instead of fast-app-switch.
...
/*!
 ...
 | googlePlusExtraPermissions | NSString    | A comma delimited list of Google+ extended permissions to request from the user **when using <a target="_blank" href="http://developers.gigya.com/035_Mobile_SDKs/010_iPhone#Adding_Google.2B_Native_Login">native login</a>**. |
 | pendingRegistration        | NSNumber    | A Boolean value indicating whether the account should not be considered final until <a target="_blank" href="http://developers.gigya.com/037_API_reference/010_Socialize/socialize.notifyRegistration">socialize.notifyRegistration</a> is called. Default is `YES`. |
...
/*!
 ...
 If the user selects a provider that supports <a target="_blank" href="http://developers.gigya.com/035_Mobile_SDKs/010_iPhone#c._Additional_Provider_Configuration">native login</a>, it will be used seamlessly from the provider selection view.
 Calling this method when the user is already logged in will result in an exception.
...
/*!
 ...
 | facebookLoginBehavior      | NSNumber    | A <a target="_blank" href="https://developers.facebook.com/docs/reference/ios/current/class/FBSDKLoginManager/#FBSDKLoginBehavior enum">FBSDKLoginBehavior</a> value determining the Facebook SDK login behavior. |
 | googleExtraPermissions     | NSString    | This parameter gives the possibility to request extended permissions in addition to the permissions that Gigya is already requesting. The supported values are: "wallet" - for Google wallet permissions. |
 | googlePlusExtraPermissions | NSString    | A comma delimited list of Google+ extended permissions to request from the user **when using <a target="_blank" href="http://developers.gigya.com/035_Mobile_SDKs/010_iPhone#Adding_Facebook_Native_Login">native login</a>**. |
 | pendingRegistration        | NSNumber    | A Boolean value indicating whether the account should not be considered final until <a target="_blank" href="http://developers.gigya.com/037_API_reference/010_Socialize/socialize.notifyRegistration">socialize.notifyRegistration</a> is called. Default is `YES`. |
 | sessionExpiration          | NSNumber    | A time interval that defines the time in seconds that Gigya should keep the login session valid for the user. If this parameter is not specified, the session will be valid forever. |
 | forceAuthentication        | NSNumber    | A Boolean value indicating whether the user will be forced to provide his social network credentials during login, even if he is already connected to the social network. Default is `NO` |
 | temporaryAccount           | NSNumber    | A Boolean value indicating whether the account is temporary and is only accessible with the associated access token. This means that it is not possible to access the same account, and get the same Gigya UID again by using login. Default is `NO`. |
...
/**
 ...
 If the user has logged in to Facebook or Google+ via <a target="_blank" href="http://developers.gigya.com/035_Mobile_SDKs/010_iPhone#c._Additional_Provider_Configuration">native login</a>, this method will log out from the corresponding native SDKs as well.
 */
+ (void)logout;
...
/**
 ...
 If the provider is Facebook or Google+, and <a target="_blank" href="http://developers.gigya.com/035_Mobile_SDKs/010_iPhone#c._Additional_Provider_Configuration">native login</a> was used, this method will log out from the corresponding native SDK as well.
 Calling this method when the user isn't logged in (there is no Gigya session) will result in an exception.
...
/*!
 Uses <GSPluginView> to render Gigya <a target="_blank" href="http://developers.gigya.com/010_Developer_Guide/18_Plugins">JS Plugins</a> and display them modally.
...
/*!
 ...
 This method works only with <a target="_blank" href="http://developers.gigya.com/035_Mobile_SDKs/010_iPhone#Adding_Facebook_Native_Login">Facebook native login</a>, and must be called after the user logged in.
